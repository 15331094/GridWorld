...
public class SparseBoundedGrid<E> implements Grid<E> {
	...
	public E put(Location loc, E obj) {
        ...
        OccupantInCol newocc = new OccupantInCol(obj, loc.getCol());
        if (StoreInRow[loc.getRow()] == null)
        	StoreInRow[loc.getRow()] = new LinkedList();
        StoreInRow[loc.getRow()].addLast(newocc);
        return oldOccupant;
	}
